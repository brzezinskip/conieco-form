...
const InvitationsConfig: IInvitationsConfig = {
  ...
  "boarding-pass": {
    ...
    softTouch: true,
    folderQuestions: { colors: ["Granat", "Czarny", "Beżowo-złoty", "Srebrny"], decorations: ["Papierowa opaska ze złoceniem (3 zł)", "Folder (granat - 4,5 zł)", "Folder (czarny - 4,5 zł)", "Folder (beżowo-srebrny - 4,5 zł)", "Folder (srebrny - 4,5 zł)", "Zamknięcie folderu złotym/srebrnym sznureczkiem (1 zł)"] },
  },
  "elisa": {
